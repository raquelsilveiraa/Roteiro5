...
public class TestaConjuntoDinamico {
	...
	public void removerTeste() throws Exception {
		...
		cd.inserir(1);
		cd.inserir(5);
		Assert.assertEquals(Integer.valueOf(2), cd.remover(2));
		Assert.assertEquals(3, cd.tamanho());
		
		Assert.assertEquals(Integer.valueOf(1), cd.remover(1));
		Assert.assertEquals(2, cd.tamanho());
		
		Assert.assertEquals(Integer.valueOf(5), cd.remover(5));
		Assert.assertEquals(1, cd.tamanho());
	...
	public void buscarTeste() throws Exception {
		...
		cd.inserir(10);
		cd.inserir(8);
		Assert.assertEquals(Integer.valueOf(10), cd.buscar(10));
	}
	...
	public void minimumTeste() throws Exception {
		...
		cd.inserir(10);
		cd.inserir(8);
		Assert.assertEquals(Integer.valueOf(4),cd.minimum());
	...
	public void maximumTest() throws Exception {
		...
		cd.inserir(10);
		cd.inserir(8);
		Assert.assertEquals(Integer.valueOf(10),cd.maximum());
	}
	...
	public void sucessorTeste() throws Exception {
		...
		cd.inserir(10);
		cd.inserir(8);
		Assert.assertEquals(Integer.valueOf(5),cd.sucessor(4));
		Assert.assertEquals(Integer.valueOf(10),cd.sucessor(5));
		Assert.assertNull(cd.sucessor(8));
		Assert.assertEquals(Integer.valueOf(8),cd.sucessor(10));
	}
	...
	public void predecessorTeste() throws Exception {
		...
		Assert.assertEquals(Integer.valueOf(5) ,cd.predecessor(10));
		Assert.assertEquals(Integer.valueOf(4),cd.predecessor(5));
		Assert.assertEquals(Integer.valueOf(10),cd.predecessor(8));
